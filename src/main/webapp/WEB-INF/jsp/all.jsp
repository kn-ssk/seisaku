...
<body>
	<div id="wrapper">
		...
		<form action="MbtiServlet" method="post">
			...
			<button type="submit" name="mbti" value="4" class="btn">ENTP</button><br>
			...
			<button type="submit" name="mbti" value="8" class="btn green-btn">ENFP</button><br>
			...
			<button type="submit" name="mbti" value="12" class="btn blue-btn">ESTJ</button><br>
